...
if len(sys.argv) == 2:
    ...
    print("Default number of requests: 15000(2**100)")
    sys.exit(1)
...
def generate_url_path():
    str_path = string.ascii_letters + string.digits + string.punctuation
...
def attack():
    ...
    try:
        ...
        print("LWDE SITE NAME SAHI DAL OR WEBSITE GAYI SAYAD!!")
        sys.exit(2)
